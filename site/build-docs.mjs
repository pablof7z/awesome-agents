...
const pages = [
  {
    ...
    description: "Install reusable operational agent profiles, author your own source repositories, and target Codex, Claude Code, OpenCode, Goose, or Hermes.",
    body: `
      ...
      <section class="docs-section docs-section-first">
        ...
        <dl class="docs-dl">
          ...
          <div>
            ...
            <dd>The destination renderer for Codex, Claude Code, OpenCode, Goose, or Hermes.</dd>
          </div>
          <div>
            <dt>Install scope</dt>
            <dd>Project-local where supported. Codex and Hermes install globally because they load user-level profiles.</dd>
          </div>
        </dl>
      </section>
    `
  ...
  },
  {
    ...
    description: "Codex, Claude Code, OpenCode, Goose, and Hermes expect different profile file locations and run flows.",
    body: `
      <section class="docs-section docs-section-first">
        ...
        <div class="docs-table-wrap">
          <table class="docs-table">
            ...
            <tbody>
              ...
              <tr><td>Hermes</td><td>Not supported</td><td><code>$HERMES_HOME/profiles/&lt;profile&gt;/SOUL.md</code></td><td><code>hermes -p &lt;profile&gt; chat</code></td></tr>
            </tbody>
          </table>
        </div>
      </section>
    ...
    body: `
      <section class="docs-section docs-section-first">
        ...
        <div class="docs-command-list compact">
          ...
          <div><code>HERMES_HOME</code><span>Hermes home containing named profiles. Defaults to <code>~/.hermes</code>.</span></div>
  ...
  },
  {
    ...
    body: `
      <section class="docs-section docs-section-first">
        ...
        <h2>Start with the exact error.</h2>
        <dl class="docs-dl">
          <div>
            <dt>No harness detected</dt>
            <dd>Pass <code>--harness codex</code>, <code>--harness claude-code</code>, <code>--harness opencode</code>, <code>--harness goose</code>, or <code>--harness hermes</code>.</dd>
          </div>
          <div>
...
function header() {
  ...
  <div class="nav-inner">
    ...
    <nav class="nav-links" aria-label="Primary">
      ...
      <a href="https://github.com/pablof7z/awesome-agents" rel="noopener" class="nav-icon" aria-label="GitHub">
