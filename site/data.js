...
window.AGENTS = [
  ...
  },
  {
    ...
    activity: [10, 12, 15, 18, 22, 27, 33, 41],
  ...
  },
  {
    ...
    installs: 3910,
    examples: 51,
    excerpt: "Brief: three vendors meet the SOC2 requirement; only one supports EU data residency (source: docs, 2026-05).",
    activity: [8, 7, 11, 14, 13, 20, 26, 28],
  ...
  },
  {
    ...
    activity: [5, 5, 8, 10, 9, 15, 19, 24],
    tags: ["coordination", "ops"],
  },
  {
    slug: "support-triage",
    name: "Support Triage",
    ...
    installs: 2680,
    examples: 46,
    excerpt: "Sev-2 · billing · likely a proration bug. Drafted reply + linked the two matching prior tickets.",
    activity: [7, 8, 9, 11, 13, 16, 19, 23],
    tags: ["support", "ops"],
  },
  {
    ...
    installs: 2260,
    examples: 40,
    excerpt: "Added — copy-to-clipboard on every install command. Fixed — dark-mode contrast on the leaderboard.",
    activity: [6, 6, 7, 9, 10, 12, 15, 18],
