...
const PAGES = [
  {
    ...
    blocks: [
      ...
      ["p", "A profile is read from a YAML or Markdown file under <code>agents/&lt;slug&gt;/</code>, adapted for the harness you target, and written into the right place for Claude&nbsp;Code, Codex, OpenCode, or tenex-edge. Sources are GitHub repos, Git URLs, or local checkouts."],
  ...
  },
  {
    ...
    blocks: [
      ...
      ["ul", [
        "<code>--harness codex|claude-code|opencode|tenex-edge|*</code> targets specific harnesses. Without it, the CLI detects harness CLIs on <code>PATH</code>.",
  ...
  },
  {
    ...
    blocks: [
      ...
      ["p", "Each falls back to a sensible home (<code>~/.codex</code>, <code>~/.claude</code>, <code>~/.config/opencode</code>, <code>~/.tenex-edge</code>) when the env var is unset."],
      ...
      ["p", "Codex expects a plain profile name, not a path passed to <code>--profile</code>."],
    ],
  },
  {
