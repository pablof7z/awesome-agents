...
const banner = [
  ...
  `  ${ui.dim("Operational profiles for Codex, Claude Code, OpenCode, Goose, and Hermes")}`
];

const mainHelp = {
  banner,
  usage: `${PACKAGE_NAME} <command> [options]`,
  description: "Install reusable operational agent profiles into Codex, Claude Code, OpenCode, Goose, and Hermes.",
  sections: [
    {
  ...
  examples: [
    ...
    { command: `${PACKAGE_NAME} add ${exampleSource} --agent ${exampleProfile} --harness hermes` },
...
const commandHelp = {
  add: {
    ...
    sections: [
      {
        ...
        rows: [
          ...
          "3. Render Codex, Claude Code, OpenCode, Goose, or Hermes files and record them in the registry."
        ]
      },
      {
        title: "Source Forms:",
      ...
      },
      {
        ...
        rows: [
          ...
          { term: ui.option("--harness codex hermes"), description: "Render for multiple harnesses" },
      ...
      },
      {
        ...
        rows: [
          ...
          { term: ui.command("hermes"), description: `${ui.path("~/.hermes/profiles/<profile>/SOUL.md")} (project-local Hermes profiles are not supported)` },
    ...
    examples: [
      ...
      { command: `${PACKAGE_NAME} add ${exampleSource} --agent ${exampleProfile}` },
      { command: `${PACKAGE_NAME} add ${exampleSource} --agent ${exampleProfile} --harness codex hermes` },
...
function installOptions({ includeHome = false } = {}) {
  return compact([
    ...
    { term: ui.option("-p, --project"), description: "Install into the current project; not supported for Codex or Hermes profiles" },
