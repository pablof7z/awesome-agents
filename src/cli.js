...
export async function run(argv = process.argv) {
  ...
  program
    .name(PACKAGE_NAME)
    .description("Install reusable agent profiles into Codex, Claude Code, OpenCode, Goose, and Hermes.")
...
function addInstallCommand(program, commandName) {
  program
    ...
    .option("-p, --project", "Install into the current project; not supported for Codex or Hermes profiles")
